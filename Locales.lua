...
if L then
    ...
    L["Show detailed time on hover"] = "Show detailed time on hover"
    L["Show detailed time on hover when at least one minute remains"] = "Show detailed time on hover when at least one minute remains"
    L["Enable"] = "Enable"
    L["Format"] = "Format"
    L["Seconds"] = "Seconds"
    L["Color"] = "Color"
...
if L then
    ...
    L["Show detailed time on hover"] = "Показывать подробное время при наведении"
    L["Show detailed time on hover when at least one minute remains"] = "Показывать подробное время при наведении, если осталось не менее минуты"
    L["Enable"] = "Включить"
    L["Format"] = "Формат"
    L["Seconds"] = "Секунды"
    L["Color"] = "Цвет"
...
if L then
    ...
    L["Show detailed time on hover"] = "Detaillierte Zeit beim Darüberfahren anzeigen"
    L["Show detailed time on hover when at least one minute remains"] = "Beim Darüberfahren detaillierte Zeit anzeigen, wenn mindestens eine Minute verbleibt"
    L["Enable"] = "Aktivieren"
    L["Format"] = "Format"
    L["Seconds"] = "Sekunden"
    L["Color"] = "Farbe"
...
if L then
    ...
    L["Show detailed time on hover"] = "Mostrar tempo detalhado ao passar o cursor"
    L["Show detailed time on hover when at least one minute remains"] = "Mostrar o tempo detalhado ao passar o cursor quando restar pelo menos um minuto"
    L["Enable"] = "Ativar"
    L["Format"] = "Formato"
    L["Seconds"] = "Segundos"
    L["Color"] = "Cor"
...
if L then
    ...
    L["Show detailed time on hover"] = "Afficher le temps détaillé au survol"
    L["Show detailed time on hover when at least one minute remains"] = "Afficher le temps détaillé au survol lorsqu'il reste au moins une minute"
    L["Enable"] = "Activer"
    L["Format"] = "Format"
    L["Seconds"] = "Secondes"
    L["Color"] = "Couleur"
...
if L then
    ...
    L["Show detailed time on hover"] = "Mostrar tiempo detallado al pasar el cursor"
    L["Show detailed time on hover when at least one minute remains"] = "Mostrar el tiempo detallado al pasar el cursor cuando quede al menos un minuto"
    L["Enable"] = "Habilitar"
    L["Format"] = "Formato"
    L["Seconds"] = "Segundos"
    L["Color"] = "Color"
...
if L then
    ...
    L["Show detailed time on hover"] = "Mostra il tempo dettagliato al passaggio del cursore"
    L["Show detailed time on hover when at least one minute remains"] = "Mostra il tempo dettagliato al passaggio del cursore quando resta almeno un minuto"
    L["Enable"] = "Abilitare"
    L["Format"] = "Formato"
    L["Seconds"] = "Secondi"
    L["Color"] = "Colore"
...
if L then
    ...
    L["Show detailed time on hover"] = "마우스를 올리면 상세 시간 표시"
    L["Show detailed time on hover when at least one minute remains"] = "남은 시간이 1분 이상일 때 마우스를 올리면 상세 시간을 표시합니다"
    L["Enable"] = "활성화"
    L["Format"] = "형식"
    L["Seconds"] = "초"
    L["Color"] = "색상"
...
if L then
    ...
    L["Show detailed time on hover"] = "鼠标悬停时显示详细时间"
    L["Show detailed time on hover when at least one minute remains"] = "剩余时间至少为一分钟时，鼠标悬停显示详细时间"
    L["Enable"] = "启用"
    L["Format"] = "格式"
    L["Seconds"] = "秒"
    L["Color"] = "颜色"
...
if L then
    ...
    L["Show detailed time on hover"] = "滑鼠懸停時顯示詳細時間"
    L["Show detailed time on hover when at least one minute remains"] = "剩餘時間至少一分鐘時，滑鼠懸停顯示詳細時間"
    L["Enable"] = "啟用"
    L["Format"] = "格式"
    L["Seconds"] = "秒"
    L["Color"] = "顏色"
